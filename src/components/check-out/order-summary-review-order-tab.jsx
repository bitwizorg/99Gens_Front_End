...
const orderSummaryReviewOrderTab = ({ CustomClass, Img }) => {
    return (
        <div className="col-lg-4 col-md-5">
            <div className="order-summary">
                ...
                <div className="btn-out"><a href="#" className="btn btn-blue">Place Your Order</a></div>
                <div className="gray-box">Disclaimer about submiting art for moderation, time frame for review for art to be moderated will entail.</div>
            </div>
        </div>
    )
}

export default orderSummaryReviewOrderTab