          ...
          <main className="content-main">
                    ...
                    <div className="box">
                      <div className="box-inn">
                        <form>
                          ...
                          <textarea name="detailedDescription" id="commentsart2" cols={5} rows={5} placeholder="A digital painting of a puppy french poodle in space surrounded by 3d marshmallow unicorns and stars..." defaultValue="" value={state.detailedDescription} onChange={onChange} />
                        </form>
                      </div>
                      <p>Images generated by stable difussion. <a href="https://stability.ai" target="_blank">Learn more.</a></p>
                      <div className="btn-out">
                        <button name="btnart2" id="btnart2" className="btn" form="get-detailed-description" onClick={onGenerateClick} >
                          GENERATE ART
                        </button>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="heading-txt">
                      ...
                      <p>
                        Over 5,000,000 amazing images available through Lexica
                        art.
                      </p>
                      <div className="btn-out">
            ...
            <div className="featured-images">
              <div className="container">
                ...
                <div className="row">
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-1.png")} userPrompt={state.detailedDescription}></RemixSlots>
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-2.png")} userPrompt={state.detailedDescription}></RemixSlots>
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-3.png")} userPrompt={state.detailedDescription}></RemixSlots>
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-4.png")} userPrompt={state.detailedDescription}></RemixSlots>
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-5.png")} userPrompt={state.detailedDescription}></RemixSlots>
                  <RemixSlots imgSrc={withPrefix("assets/img/featured-image-6.png")} userPrompt={state.detailedDescription}></RemixSlots>
                </div>
              </div>
            </div>
            <div className="generate-art-form">
              <div className="container">
                ...
                <div className="btn-out">
                  <button name="btnart2" id="btnart2" className="btn" form="get-detailed-description" onClick={onGenerateClick2} >
                    GENERATE ART
                  </button>
                </div>
              </div>
