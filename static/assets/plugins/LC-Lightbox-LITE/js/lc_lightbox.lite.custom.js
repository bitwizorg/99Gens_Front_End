	...
	'<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing">'+
		'<div id="lcl_window">'+
			...
			'<div id="lcl_contents_wrap">'+
				'<div id="lcl_elem_over_wrap">'+
					'<div class="btns">'+
						'<a href="/select-merch" class="btn btn-blue">REMIX <em class="icn-rex"></em></a>'+
						'<a href="/select-merch" class="btn btn-blue">MERCHIFY <em class="icn-crt"></em></a>'+
					'</div>'+
				'</div>'+
				'<div id="lcl_subj">'+
	...
	var lcl = function(obj, settings) {
		...
		$(document).on('click', '.lcl_image_elem', function(e) {
			...
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
				// $('#lcl_elem_over_wrap').toggleClass('show')
			} else {
			...
			var af = new AlloyFinger(el, {
				singleTap: function(e) {
					...
					if($(e.target).attr('id') == 'lcl_overlay' && !lcl_ai_opts.modal) {
						lcl_close();	
					} else if($(e.target).attr('id') == 'lcl_elem_wrap') {
						$('#lcl_elem_over_wrap').addClass('show');
					} else if($(e.target).hasClass('btns')) {
						$('#lcl_elem_over_wrap').removeClass('show');
					}
				},
